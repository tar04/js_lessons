...
//document.getElementById('content').innerText='some text';

//-- замініть текст параграфа з id 'rules' на будь-який інший
//document.getElementById('rules').innerText='other text';
...
//let elements=document.getElementById('rules').classList;
